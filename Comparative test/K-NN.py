...
# 构建 KNN 模型
knn = KNeighborsClassifier(n_neighbors=5)  # 可以调整 n_neighbors 参数
knn.fit(X_train_2d, np.argmax(y_train, axis=1))
...
# 计算并显示每个类别的准确率
train_pred = knn.predict(X_train_2d)
train_pred_classes = train_pred
