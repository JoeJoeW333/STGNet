...
checkpoint = ModelCheckpoint('best_model_vggnet.keras', monitor='val_accuracy', save_best_only=True, mode='max', verbose=1)
...
# 加载最佳模型
model.load_weights('best_model_vggnet.keras')
